...
import AmbulanceInput from '../components/AmbulanceInput';
import { fetchAmbulanceData } from '../api/ambulanceApi';
import Navbar from "../components/Navbar";

const AmbulancePage = ({ token, onBack, onLogout, user  }) => {
  ...
  const fetchData = async () => {
    try {
      const data = await fetchAmbulanceData(token);
      ...
      if (data.length > 0) {
        ...
        // Extract completed weeks from ambulance data
      ...
      console.error('Gagal mengambil data ambulance:', error.message);
    }
  };
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1 text-sm sm:text-base">
                Kelola dan pantau data ambulance dengan mudah
              </p>
              {/* Progress Summary */}
          ...
          {ambulanceData.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-sm">
                Data ambulance akan muncul setelah Anda menginput data pada minggu yang dipilih
              </p>
            </div>
          ) : (
            <div className="overflow-hidden rounded-xl border border-gray-200">
              <AmbulanceTable data={ambulanceData} bulan={bulan} />
            </div>
          )}
        </div>
      </div>
